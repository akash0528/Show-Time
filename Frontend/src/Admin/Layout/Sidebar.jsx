...
const Sidebar = () => {
  ...
  return (
    <div className="w-74 bg-blue-950 text-white h-screen  flex flex-col">
      ...
      {/* TOP */}
      <div className="p-6">
        <h1 className="text-4xl  mb-4 text-center font-black italic tracking-tighter uppercase">Show-time</h1>
            <h3 className=" text-2xl text-center py-2 font-black italic tracking-tighter uppercase">Admin Panel</h3>
        {links.map((link) => (
          <NavLink
            key={link.name}
            to={link.path}
